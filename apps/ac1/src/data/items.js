...
export const ITEMS = {
    ...
    health_potion: {
        ...
        color: 0xcc2222, stackable: true, buyPrice: 25, sellPrice: 8,
    ...
    mana_potion: {
        ...
        color: 0x2244cc, stackable: true, buyPrice: 20, sellPrice: 6,
    ...
    ancient_scroll: {
        ...
        color: 0xddaa00, stackable: false, buyPrice: 60, sellPrice: 20,
    ...
    forest_herb: {
        ...
        color: 0x33cc44, stackable: true, buyPrice: 12, sellPrice: 4,
    ...
    heart_crystal: {
        ...
        color: 0xff4488, stackable: false, buyPrice: 100, sellPrice: 35,
    ...
    eldritch_tome: {
        ...
        color: 0x8800ff, stackable: false, buyPrice: 150, sellPrice: 50,
    ...
    tent: {
        ...
        color: 0x886644, stackable: false, buyPrice: 120, sellPrice: 40,
        onUse: (stats) => {
    ...
    iron_axe: {
        ...
        color: 0x888888, stackable: false, buyPrice: 45, sellPrice: 15,
        onUse: () => false,
    },
    iron_pickaxe: {
        id: 'iron_pickaxe', name: 'Iron Pickaxe',
        description: 'Required to gather Mineral Ore nodes.',
        color: 0x777788, stackable: false, buyPrice: 50, sellPrice: 17,
        onUse: () => false,
    },
    ...
    wood: {
        ...
        color: 0x8b5e3c, stackable: true, sellPrice: 4, onUse: () => false,
    },
    mineral_ore: {
        id: 'mineral_ore', name: 'Mineral Ore',
        description: 'Raw ore from a mineral vein. Can be smelted or traded for Glint.',
        color: 0x8888aa, stackable: true, sellPrice: 8, onUse: () => false,
    },
    ...
    expanded_haversack: {
        ...
        color: 0x886633, stackable: false, buyPrice: 120, sellPrice: 40,
    ...
    runic_satchel: {
        ...
        color: 0xaa55ff, stackable: false, buyPrice: 280, sellPrice: 90,
    ...
    scholars_tunic: {
        ...
        color: 0x334488, stackable: false, slot: 'body', tier: 1,
    ...
    violet_silk_robes: {
        ...
        color: 0x6622aa, stackable: false, slot: 'body', tier: 2,
    ...
    scholars_cowl: {
        ...
        color: 0x224466, stackable: false, slot: 'head', tier: 1,
    ...
    iron_ring: {
        ...
        color: 0x888888, stackable: false, slot: 'accessory', tier: 1,
    ...
    resonance_amulet: {
        ...
        color: 0xffaa44, stackable: false, slot: 'accessory', tier: 2,
    ...
    novice_staff: {
        ...
        color: 0x9b6e4c, stackable: false, slot: 'weapon', tier: 1, weaponType: 'staff', rarity: 'common',
    ...
    weathered_sage_staff: {
        ...
        color: 0x8a7060, stackable: false, slot: 'weapon', tier: 1, weaponType: 'staff', rarity: 'common',
    ...
    adepts_spire: {
        ...
        color: 0x44aaff, stackable: false, slot: 'weapon', tier: 2, weaponType: 'staff', rarity: 'uncommon',
    ...
    mossy_branch_staff: {
        ...
        color: 0x4a9944, stackable: false, slot: 'weapon', tier: 2, weaponType: 'staff', rarity: 'uncommon',
    ...
    verdant_focus: {
        ...
        color: 0x22ccff, stackable: false, slot: 'weapon', tier: 3, weaponType: 'staff', rarity: 'rare',
    ...
    crystalline_rod: {
        ...
        color: 0x88ccff, stackable: false, slot: 'weapon', tier: 3, weaponType: 'staff', rarity: 'rare',
    ...
    void_channel: {
        ...
        color: 0x7733cc, stackable: false, slot: 'weapon', tier: 4, weaponType: 'staff', rarity: 'epic',
    ...
    arcane_sceptre: {
        ...
        color: 0x9944ff, stackable: false, slot: 'weapon', tier: 4, weaponType: 'staff', rarity: 'epic',
    ...
    staff_of_first_covenant: {
        ...
        color: 0xffd700, stackable: false, slot: 'weapon', tier: 5, weaponType: 'staff', rarity: 'legendary',
    ...
    iron_spell_blade: {
        ...
        color: 0x999999, stackable: false, slot: 'weapon', tier: 1, weaponType: 'spell_blade', rarity: 'common',
    ...
    etched_shortsword: {
        ...
        color: 0x888888, stackable: false, slot: 'weapon', tier: 1, weaponType: 'spell_blade', rarity: 'common',
    ...
    spell_blade: {
        ...
        color: 0x44ccff, stackable: false, slot: 'weapon', tier: 2, weaponType: 'spell_blade', rarity: 'uncommon',
    ...
    arcane_saber: {
        ...
        color: 0x55aadd, stackable: false, slot: 'weapon', tier: 2, weaponType: 'spell_blade', rarity: 'uncommon',
    ...
    resonant_edge: {
        ...
        color: 0x33aaff, stackable: false, slot: 'weapon', tier: 3, weaponType: 'spell_blade', rarity: 'rare',
    ...
    mana_etched_sword: {
        ...
        color: 0x66ccff, stackable: false, slot: 'weapon', tier: 3, weaponType: 'spell_blade', rarity: 'rare',
    ...
    void_slicer: {
        ...
        color: 0x9944ff, stackable: false, slot: 'weapon', tier: 4, weaponType: 'spell_blade', rarity: 'epic',
    ...
    arcane_war_blade: {
        ...
        color: 0xcc66ff, stackable: false, slot: 'weapon', tier: 4, weaponType: 'spell_blade', rarity: 'epic',
    ...
    blade_of_the_covenant: {
        ...
        color: 0xffd700, stackable: false, slot: 'weapon', tier: 5, weaponType: 'spell_blade', rarity: 'legendary',
    ...
    crude_dagger: {
        ...
        color: 0x999999, stackable: false, slot: 'weapon', tier: 1, weaponType: 'umbral_dagger', rarity: 'common',
    ...
    shadow_shiv: {
        ...
        color: 0x888888, stackable: false, slot: 'weapon', tier: 1, weaponType: 'umbral_dagger', rarity: 'common',
    ...
    umbral_dagger: {
        ...
        color: 0x9933cc, stackable: false, slot: 'weapon', tier: 2, weaponType: 'umbral_dagger', rarity: 'uncommon',
    ...
    phantom_blade: {
        ...
        color: 0xaa55dd, stackable: false, slot: 'weapon', tier: 2, weaponType: 'umbral_dagger', rarity: 'uncommon',
    ...
    voidwhisper_dagger: {
        ...
        color: 0xcc44ff, stackable: false, slot: 'weapon', tier: 3, weaponType: 'umbral_dagger', rarity: 'rare',
    ...
    dusk_fang: {
        ...
        color: 0xff88cc, stackable: false, slot: 'weapon', tier: 3, weaponType: 'umbral_dagger', rarity: 'rare',
    ...
    midnight_reaver: {
        ...
        color: 0x880099, stackable: false, slot: 'weapon', tier: 4, weaponType: 'umbral_dagger', rarity: 'epic',
    ...
    ecliptic_stiletto: {
        ...
        color: 0xcc00cc, stackable: false, slot: 'weapon', tier: 4, weaponType: 'umbral_dagger', rarity: 'epic',
    ...
    twilight_fang: {
        ...
        color: 0xffd700, stackable: false, slot: 'weapon', tier: 5, weaponType: 'umbral_dagger', rarity: 'legendary',
    ...
    carved_shortbow: {
        ...
        color: 0x9b7055, stackable: false, slot: 'weapon', tier: 1, weaponType: 'resonance_bow', rarity: 'common',
    ...
    hunters_shortbow: {
        ...
        color: 0x887755, stackable: false, slot: 'weapon', tier: 1, weaponType: 'resonance_bow', rarity: 'common',
    ...
    resonance_bow: {
        ...
        color: 0x88ddaa, stackable: false, slot: 'weapon', tier: 2, weaponType: 'resonance_bow', rarity: 'uncommon',
    ...
    forest_longbow: {
        ...
        color: 0x66aa66, stackable: false, slot: 'weapon', tier: 2, weaponType: 'resonance_bow', rarity: 'uncommon',
    ...
    aether_strung_bow: {
        ...
        color: 0x44cc88, stackable: false, slot: 'weapon', tier: 3, weaponType: 'resonance_bow', rarity: 'rare',
    ...
    spirit_bow: {
        ...
        color: 0x88ffcc, stackable: false, slot: 'weapon', tier: 3, weaponType: 'resonance_bow', rarity: 'rare',
    ...
    celestial_arc: {
        ...
        color: 0x9944ff, stackable: false, slot: 'weapon', tier: 4, weaponType: 'resonance_bow', rarity: 'epic',
    ...
    tempest_bow: {
        ...
        color: 0xaa66ff, stackable: false, slot: 'weapon', tier: 4, weaponType: 'resonance_bow', rarity: 'epic',
    ...
    eternal_draw: {
        ...
        color: 0xffd700, stackable: false, slot: 'weapon', tier: 5, weaponType: 'resonance_bow', rarity: 'legendary',
