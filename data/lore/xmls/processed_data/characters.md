# Refined Characters of Arcane Majesty (Linear Era: 0 GD)

This file contains the character data established during the era of "A Tapestry of Souls."
...
- **Name:** Valen
- **Race:** Nythorian
- **Role:** Resistance Warrior
- **Description:** A tragic warrior fighting against the Void.
- **Backstory:** A high-ranking member of the resistance whose family was destroyed by the Void; he sacrifices himself to protect Anya and Seraphina during the Great Darkness.
- **Relationships:**
    - `ALLY_OF` Anya
    - `ALLY_OF` Seraphina
- **Origin:** Underworld
...
- **Name:** Nyktoros
- **Race:** Ancient Entity
- **Role:** Ruler of the Void
- **Description:** A towering shadowy figure seeking to consume all light.
- **Backstory:** An ancient being who awakens to cast the Great Darkness (0 GD) across the realms.
- **Relationships:**
    - `ENEMIES_OF` All Mortal Life
    - `WARDEN_IS` Anya
...
- **Description:** A primordial entity of the aether tasked with maintaining the balance between the planes.
- **Backstory:** Plucked Anya from Auroria and created the rift between worlds to stop the cosmic collapse caused by the vampiric soul-imbalance.
- **Origin:** The Aether

## Future Era Entities (~300 AGD)
